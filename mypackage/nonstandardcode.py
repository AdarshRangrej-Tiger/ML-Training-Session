...
# Define constants for dataset URL and local paths
...
# Create income categories to use for stratified sampling
...
# Drop the income_cat column as it is no longer needed
for set_ in (strat_train_set, strat_test_set):
    set_.drop("income_cat", axis=1, inplace=True)

# Copy the stratified training set for further analysis
housing = strat_train_set.copy()

# Plot geographical data to visualize it
...
# Add the new feature combinations to the DataFrame
